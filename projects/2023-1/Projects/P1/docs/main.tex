...
\begin{itemize}
    \item \textbf{Sistema Operativo: } Ubuntu 22.10 x86\_64, Minimal Install. También probado con Manjaro Linux 22.0 x86\_64
    ...
    \item \textbf{Lenguaje de Programación: }Python 3.10.7 x86\_64, Compilado desde apt como un .deb, incluye python3-pip,
        También probado con la versión de Arch 
...
técnicas ampliamente usadas: Top-Down y Memorización. Estas 
